...
class CAFM(nn.Module):
    def __init__(self):
        ...
        # 修改通道数为64
        self.avg1 = nn.Conv2d(64, 32, 1)
        self.avg2 = nn.Conv2d(64, 32, 1)
        self.max1 = nn.Conv2d(64, 32, 1)
        self.max2 = nn.Conv2d(64, 32, 1)

        self.avg11 = nn.Conv2d(32, 64, 1)
        self.avg22 = nn.Conv2d(32, 64, 1)
        self.max11 = nn.Conv2d(32, 64, 1)
        self.max22 = nn.Conv2d(32, 64, 1)
...
class LinAngularXCA_CA(nn.Module):
    def __init__(self):
        ...
        # 修改输入通道数为64
        self.la = LinAngularAttention(in_channels=64)
        self.xa = XCA(dim=64)
        self.cafm = CAFM()
