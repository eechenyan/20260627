...
class MyTrainSetLoader_Kfold(Dataset):
    def __init__(self, dataset_dir, test_scene_id):
        ...
        #scene_list = ['Bikes', 'dishes', 'Flowers', 'greek', 'museum', 'Palais_du_Luxembourg', 'rosemary',                       'Sphynx','Swans_1', 'Vespa']# 10个场景
        #print(scene_list)
        

        #scene_list = ['I1', 'I2', 'I3', 'I4', 'I5', 'I6', 'I7', 'I8']# 8个场景
        #print(scene_list)
