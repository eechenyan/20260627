...
def val(valset_dir, test_scene_id, load_model_path, type = 'val'):
    ...
    device = 'cuda:5'
    from MyTrain10e import parse_args
...
if __name__ == "__main__":
    # 设置验证参数
    valset_dir = "./Data/PVBLiF_NBU_9_9_32_32_patch/"  # 验证集路径
    test_scene_id = [1,2,3,4]  # 场景索引范围
    load_model_path = "./Nets/NBUNets/01/LF_epoch6.pth.tar"  # 模型路径

    # 调用验证函数
    val(valset_dir, test_scene_id, load_model_path)